...
This outlines how to propose a change to rbioanp. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/rbioanp", fork = TRUE)`.
...
Please note that the rbioanp project is released with a [Contributor
Code of
